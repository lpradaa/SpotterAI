...
def salud() -> dict:
    ...
    return {"estado": "listo", "modelo": NOMBRE_DEL_MODELO, "dimensiones": DIMENSIONES}
...
def vector(peticion: Peticion) -> Respuesta:
    ...
    # Normalizado aqui y no en el backend: la similitud del coseno entre dos
    # vectores de longitud 1 es su producto escalar, y eso deja el lado Java
    # como una suma de productos sin raices cuadradas ni divisiones. Tambien
    # evita que dos implementaciones normalicen de forma distinta.
