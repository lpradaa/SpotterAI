...
public class SembradorDemo implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        Usuario yo = persona("Alex Moreno", EMAIL_DEMO, CLAVE_DEMO, 28, "Intermedio",
                ...
                "Llevo dos años en esto y ya se me pasó la fase de venir solo cuando me apetece. Prefiero alguien más flojo que aparezca siempre a uno fuerte que cancele media semana. Y agradezco que me metan prisa: si me dejan, me quedo con el móvil entre series.");
        ...
        Usuario marta = persona("Marta Ibáñez", "marta@spotterai.test", CLAVE_DEMO, 27, "Intermedio",
                ...
                "Voy cuatro días y me organizo bien, pero hay ejercicios que no hago sola porque me da miedo quedarme pillada. Busco a alguien para esos ratos. No necesito que sea un fenómeno, con que esté atento y cuente en voz alta me vale.");
        ...
        Usuario javi = persona("Javi Ortega", "javi@spotterai.test", CLAVE_DEMO, 30, "Intermedio",
                ...
                "Vengo de competir y sigo entrenando como si compitiera: mucho peso, pocas repeticiones y descansos largos. Necesito a alguien que pueda ayudarme en las series fuertes, solo no las saco. Aviso: soy pesado con la técnica y no me callo si veo que alguien va a hacerse daño.");
        ...
        Usuario lucia = persona("Lucía Ferrer", "lucia@spotterai.test", CLAVE_DEMO, 25, "Principiante",
                ...
                "Empecé en enero y todavía me da corte la zona donde están los que van en serio. Acabo escondiéndome en las máquinas aunque sé que no me conviene. Busco a alguien con paciencia que me deje preguntar tonterías sin poner cara.");
        ...
        Usuario diego = persona("Diego Salas", "diego@spotterai.test", CLAVE_DEMO, 34, "Avanzado",
                ...
                "Entreno a las siete de la mañana porque es la única hora que nadie me toca. A esa hora no hay nadie y se está bien. Busco a alguien que aguante madrugar, que es la parte difícil; lo demás se apaña sobre la marcha.");
        ...
        Usuario noa = persona("Noa Prieto", "noa@spotterai.test", CLAVE_DEMO, 29, "Intermedio",
                ...
                "Vengo del running y este año he empezado con las pesas porque me lesionaba. No tengo un plan cerrado y me da bastante igual lo que toque: me adapto a lo que haga el otro y así aprendo. Eso sí, no quiero meterme en nada demasiado serio.");
        ...
        Usuario hugo = persona("Hugo Bermejo", "hugo@spotterai.test", CLAVE_DEMO, 22, "Intermedio",
                ...
                "Llevo años con la misma rutina y no pienso cambiarla. Vengo tanto a entrenar como a despejarme, así que me gusta charlar entre series. Si buscas a alguien que te cronometre los descansos y no abra la boca, no soy yo.");
        ...
        Usuario carmen = persona("Carmen Vidal", "carmen@spotterai.test", CLAVE_DEMO, 31, "Intermedio",
                ...
                "Voy por la tarde, y si hace falta me muevo de sitio sin problema porque vivo entre dos. Voy a mi ritmo, ni compito ni pretendo. Lo único que quiero es no volver a dejarlo como me pasó hace dos años.");
        ...
        Usuario ruben = persona("Rubén Casas", "ruben@spotterai.test", CLAVE_DEMO, 26, "Principiante",
                ...
                "Me acabo de mudar al barrio y no conozco a nadie, así que más que un compañero busco no venir solo. Hago un poco de todo y me adapto al plan de otro sin problema. Voy justito de nivel, aviso, pero vengo cuando digo que vengo.");
        ...
        Usuario elena = persona("Elena Sanz", "elena@spotterai.test", CLAVE_DEMO, 38, "Avanzado",
                ...
                "Compito, así que sigo un plan cerrado que no puedo cambiar para adaptarme a nadie: quien venga conmigo tiene que ir a lo suyo en paralelo. A cambio no falto nunca y sé asegurar bien cuando hace falta.");
        ...
        Usuario pablo = persona("Pablo Nieto", "pablo@spotterai.test", CLAVE_DEMO, 33, "Intermedio",
                "Hipertrofia", centro, Rutina.TORSO_PIERNA, "ascua",
                "Vengo a mediodía escapándome del trabajo, con el tiempo justo: hora y media contando ducha. Eso es poco descanso y nada de charla, y no es por antipatía. Busco a alguien con la misma prisa, que si no acabo viniendo solo.");
        ...
        Usuario sara = persona("Sara Ollero", "sara@spotterai.test", CLAVE_DEMO, 27, "Intermedio",
                ...
                "Vuelvo de una lesión de hombro y voy con mucho cuidado. Sigo lo que me dijo el fisio, así que hay cosas que no voy a hacer aunque me digan que ya estoy bien. Busco a alguien tranquilo que no me anime a levantar de más.");
